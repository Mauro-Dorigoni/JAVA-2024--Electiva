...
<head>
    ...
    <title>Admin Dashboard - Modificacion de Ejemplar</title>
    ...
    <div class="container-fluid">
		...
		<div class="main-content">
		    <div class="form-container">
		        <h1>Modificación de Ejemplar</h1>
		        <form action="<%=request.getContextPath()%>/modifyEjemplar" method="POST">
		            <!-- Selección de Libro -->
		            ...
		            <!-- Campos del Ejemplar seleccionados -->
		            <div class="form-group">
		            ...
		            <div class="form-group">
		                <input data-mdb-ripple-init class="btn btn-custom btn-block btn-md" type="submit" value="MODIFICAR EJEMPLAR"/>
		            </div>
		        </form>
		    </div>
		</div>
