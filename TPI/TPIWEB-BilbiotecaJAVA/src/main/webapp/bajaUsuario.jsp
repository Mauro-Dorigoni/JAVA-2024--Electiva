            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="<%=request.getContextPath()%>/deleteUser" method="post">
                            <h3 class="text-center text-info">Baja de Cuenta</h3>
                            <input type="hidden" id="userEmail" name="userEmail" value="<%=userEmail%>">
                            <div class="form-group">
                                <label for="curpassword" class="text-info">Ingrese su Contraseña</label>
                            ...
                            <div class="form-group d-flex justify-content-between align-items-center">
                                ...
                                <input type="submit" name="submit" class="btn btn-custom btn-md" value="Baja" style="width:48%">
                            </div>
                        </form>
                    </div>
                </div>
